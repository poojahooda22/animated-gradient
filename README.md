...
If you are developing a production application, we recommen
...
export default tseslint.confi
  languageOptions
    // other options..
    parserOptions: 
      project: ['./tsconfig.node.json', './tsconfig.a
...
- Replace `tseslint.configs.recommended` to `tseslint.configs.recommendedTypeChecked` or `tseslint.configs.strictTypeCheck
