...
If you are developing a production application, we recom
- Configure the top-level `parserOptions` propert
``
export default tseslint.confi
  languageOptions
    // other options.
    parserOptions:
      project: ['./tsconfig.node.jso
      tsconfigRootDir: import.met
    },
  },
